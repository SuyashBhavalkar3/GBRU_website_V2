          ...
          <div className="w-full md:w-[55%] p-10 lg:p-14 flex flex-col justify-center items-start">
            ...
            <div className="border-t border-gray-200 pt-6 w-full max-w-[420px] mt-6">
              ...
              <div className="flex justify-center gap-4 mb-8">
                <a href="https://apps.apple.com/in/app/shoption-for-irrigation-shops/id1544284156" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity bg-[#151515] text-white rounded-md overflow-hidden flex items-center h-[42px] px-3 w-[150px] justify-center">
                ...
                <a href="https://play.google.com/store/apps/details?id=com.shoption.app" target="_blank" rel="noopener noreferrer" className="hover:opacity-80 transition-opacity bg-[#151515] text-white rounded-md overflow-hidden flex items-center h-[42px] px-3 w-[150px] justify-center">
