        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mt-4">
          ...
          <div className="lg:col-span-5 flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-3">
              ...
              <a href="https://api.whatsapp.com/send/?phone=919226514174&text&type=phone_number&app_absent=0" target="_blank" rel="noopener noreferrer" className="w-full h-14 rounded-[14px] bg-[#22C55E] hover:bg-[#1eb053] text-white font-bold text-[16px] transition-all flex items-center justify-center gap-2 shadow-sm">
