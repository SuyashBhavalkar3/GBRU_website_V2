          ...
          {products.map((product) => {
            ...
            return (
              <div
                ...
                className="bg-white rounded-[24px] border border-gray-100 overflow-hidden flex flex-col transition-shadow hover:shadow-lg relative text-left w-[240px] shrink-0 p-3"
              >
