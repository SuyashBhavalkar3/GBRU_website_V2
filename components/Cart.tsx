...
export default function Cart() {
  ...
  const basePrice = 8499;
  const gstRate = 0.18;

  const subtotal = basePrice * quantity;
  // Calculate GST to match ₹1,530 exactly for qty = 1
        ...
        {quantity === 0 ? (
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-8 items-start mt-4">
            ...
            <div className="lg:col-span-7 flex flex-col gap-6">
              ...
              {/* Product Card */}
              <div className="bg-white border border-zinc-200/80 rounded-[24px] p-6 flex flex-col md:flex-row items-stretch gap-6 relative shadow-sm">
